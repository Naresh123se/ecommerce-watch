      ...
      <div className="row justify-content-center">
        <div className="col-lg-12 col-xl-7">
          <div className="card">
                ...
                <div className="row">
                  <div className="col-md-6">
                    ...
                    <p className="fs-sm">
                      ...
                      <br />
                      <a href="#!" className="text-purple">john@email.com</a>
                    </p>
                  </div>
                  <div className="col-md-6 text-md-end">
            ...
            <a href="#!" className="btn btn-dark btn-lg card-footer-btn justify-content-center text-uppercase-bold-sm hover-lift-light">
              <span className="svg-icon text-white me-2">
                <svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewBox="0 0 512 512">
                  <title>ionicons-v5-g</title>
                  <path d="M336,208V113a80,80,0,0,0-160,0v95" style={{ fill: 'none', stroke: '#000', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: '32px' }} />
                  <rect x="96" y="208" width="320" height="272" rx="48" ry="48" style={{ fill: 'none', stroke: '#000', strokeLinecap: 'round', strokeLinejoin: 'round', strokeWidth: '32px' }} />
                </svg>
              </span>
              Pay Now
            </a>
